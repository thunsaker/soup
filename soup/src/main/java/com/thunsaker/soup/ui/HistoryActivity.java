...
//                        ((ListView) findViewById(R.id.listViewHistoryLastWeek)).setSelectionAfterHeaderView();
//                        return true;
//                    case 2: // FoursquarePrefs.History.View.LAST_MONTH
//                        ((ListView) findViewById(R.id.listViewHistoryLastMonth)).setSelectionAfterHeaderView();
//                        return true;
//                    default: // FoursquarePrefs.History.View.TODAY
//                        ((ListView) findViewById(R.id.listViewHistoryToday)).setSelectionAfterHeaderView();
//                        return true;
//                }
...
//		getSupportFragmentManager().beginTransaction().replace(R.id.frameLayoutHistoryContainer, fragment).commit();
//		return true;
//	}
//
//    /**
