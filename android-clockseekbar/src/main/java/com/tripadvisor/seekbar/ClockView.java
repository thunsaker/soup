...
public class ClockView extends LinearLayout {
    ...
    private static boolean mHideWeekday = false;
    ...
    public ClockView(Context context, AttributeSet attrs) {
        ...
        mTimeMeridianText = (LetterSpacingTextView) view.findViewById(R.id.time_meridian_text_view);
    ...
    private void setClockText(DateTime newCurrentTime) {
        if (mIs24HourFormat) {
            ...
            mTimeMeridianText.setVisibility(View.GONE);
            ...
            mTimeMeridianText.setVisibility(View.VISIBLE);
    ...
    public void setBounds(DateTime minTime, DateTime maxTime, boolean isMaxClock, boolean showWeekday) {
        mHideWeekday = showWeekday;
        setBounds(minTime, maxTime, isMaxClock);
    }
